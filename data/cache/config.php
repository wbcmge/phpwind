...
原创内容',
			...
			'avatarUrl' => 'http://my.phpwind.com/windid/attachment',
			'hash' => 'lcvGMUOP',
			'cookie.pre' => 'Eij',
			'info.mail' => '461489451@qq.com',
			'info.url' => 'http://my.phpwind.com',
...
3:地板',
		...
		'nav' => array(
			'main' => array(
				'0' => array(
					'name' => '<a href="http://10.10.92.78/index.php?m=bbs">论坛</a>',
					'sign' => 'bbs|index|run|',
				),
				'1' => array(
					'name' => '<a href="http://www.shengli.com">兑换商城</a>',
					'sign' => '',
				),
				'2' => array(
					'name' => '<a href="http://www.shengli.com">官方网站</a>',
					'sign' => '',
				),
			),
			'bottom' => array(
			...
			'my' => array(
				'0' => array(
					'name' => '<a href="http://10.10.92.78/index.php?m=space"><em class="icon_space"></em>我的空间</a>',
					'sign' => 'space',
				),
				'1' => array(
					'name' => '<a href="http://10.10.92.78/index.php?m=my&c=fresh"><em class="icon_fresh"></em>我的关注</a>',
					'sign' => 'fresh',
				),
				'2' => array(
					'name' => '<a href="http://10.10.92.78/index.php?m=bbs&c=forum&a=my"><em class="icon_forum"></em>我的版块</a>',
					'sign' => 'forum',
				),
				'3' => array(
					'name' => '<a href="http://10.10.92.78/index.php?m=my&c=article"><em class="icon_article"></em>我的帖子</a>',
					'sign' => 'article',
				),
				'4' => array(
					'name' => '<a href="http://10.10.92.78/index.php?m=vote&c=my"><em class="icon_vote"></em>我的投票</a>',
					'sign' => 'vote',
				),
				'5' => array(
					'name' => '<a href="http://10.10.92.78/index.php?m=task"><em class="icon_task"></em>我的任务</a>',
					'sign' => 'task',
				),
				'6' => array(
					'name' => '<a href="http://10.10.92.78/index.php?m=medal"><em class="icon_medal"></em>我的勋章</a>',
					'sign' => 'medal',
				),
			),
		),
		'windid' => array(
			'windid' => 'local',
			'serverUrl' => 'http://my.phpwind.com/windid',
			'clientId' => '1',
			'clientKey' => 'a431a3b7e7aa3faa7cc37724b2950693',
			'connect' => 'db',
		),
	),
	'expires' => '0',
